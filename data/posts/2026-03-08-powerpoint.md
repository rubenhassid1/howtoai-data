...
date: 2026-03-08
slug: powerpoint
subtitle: "How to use AI to make a (fantastic) PowerPoint in 2026:"
...
1. *Save* this guide and try all three methods over the weekend.
2. *Send* it to your team's Slack or Teams channel to get them on board.
...
1. Open Claude **[Cowork](https://ruben.substack.com/p/claude-cowork)**.
...
[
![Claude in Powerpoint | Claude by Anthropic](https://substackcdn.com/image/fetch/$s_!Si5M!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8f463b28-97cc-4b92-ae8c-032a4ab73162_2560x1440.webp)

](https://substackcdn.com/image/fetch/$s_!Si5M!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8f463b28-97cc-4b92-ae8c-032a4ab73162_2560x1440.webp)*It sits on the right sidebar of your PowerPoint. Just like [Claude Excel.](https://ruben.substack.com/p/ai-couldnt-do-excel)*
...
1. Go to [gamma.app](https://gamma.app). Free account, no credit card.
2. Click **“Create new”** → **“Generate.”**
3. Type your topic and success criteria (who is it for? why?).

1. Gamma shows an outline. Tweak it. Pick a theme. Hit generate.
2. 60 seconds. Done.
...
[
![](https://substackcdn.com/image/fetch/$s_!IECm!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdd79c24a-d65c-4823-8b6a-15c52d07d4a1_3456x2172.png)

](https://substackcdn.com/image/fetch/$s_!IECm!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdd79c24a-d65c-4823-8b6a-15c52d07d4a1_3456x2172.png)*Click on the “**+**” → ‘**Connectors**’ → ‘**Manage connectors’** → Get ‘**Gamma’**.*

And then you just prompt Gamma:

[
![](https://substackcdn.com/image/fetch/$s_!0Zmz!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F35fd0096-73fa-446e-b55b-52337494eaab_3456x2078.png)

](https://substackcdn.com/image/fetch/$s_!0Zmz!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F35fd0096-73fa-446e-b55b-52337494eaab_3456x2078.png)*It’s Gamma inside Claude. Good, but you can do much better.*
...
[
![](https://substackcdn.com/image/fetch/$s_!qmuv!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2a5f84ed-5df4-42b9-b39f-39b1430c45a7_3456x2170.png)

](https://substackcdn.com/image/fetch/$s_!qmuv!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2a5f84ed-5df4-42b9-b39f-39b1430c45a7_3456x2170.png)*Step 1 done: we now have an in-depth research of my topic. *
...
5. Then pass the outline to Gamma as a presentation using textMode “generate”.Here’s the example:

[
![](https://substackcdn.com/image/fetch/$s_!oGpe!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F34e600f5-3a91-413e-8495-5e544a8dbe39_3456x2080.png)

](https://substackcdn.com/image/fetch/$s_!oGpe!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F34e600f5-3a91-413e-8495-5e544a8dbe39_3456x2080.png)*I simply copied and pasted the follow-up prompt.*
...
[
![](https://substackcdn.com/image/fetch/$s_!GtvL!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdb386fe0-c31b-4633-a45e-ea47dfef9c83_3456x2076.png)

](https://substackcdn.com/image/fetch/$s_!GtvL!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdb386fe0-c31b-4633-a45e-ea47dfef9c83_3456x2076.png)*The Gamma presentation is now made using Claude’s research.*

[
![](https://substackcdn.com/image/fetch/$s_!dIMT!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb8e2fb91-e15a-46fa-b7f6-be540aa82b7d_3456x1928.png)

](https://substackcdn.com/image/fetch/$s_!dIMT!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb8e2fb91-e15a-46fa-b7f6-be540aa82b7d_3456x1928.png)*Now that’s a solid one! Inside **Gamma**.*
...
2. Go to **Library** → **Themes** → **New Theme** → **Import Theme**.
3. Upload your **.pptx** or **Google Slides** file.
4. Gamma extracts your colors, fonts, and logo automatically. Few seconds.
5. Review. Adjust the primary accent, card backgrounds, and page colors if needed.
6. Upload a cleaner version of your logo if the extracted one looks off.
7. Click **“Save and Customize”** to fine-tune cards and buttons. Or **“Save and Finish”** if it looks right.
8. Name it clearly *(e.g., “Acme Corp Brand 2026”)*.
9. Go to **Settings** → **Workspace Defaults** → set this theme as default.

Every new Gamma now starts on-brand.

[
![](https://substackcdn.com/image/fetch/$s_!dLpy!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F26769578-d6b9-4dfa-b1b0-b00879101499_3456x1922.png)

](https://substackcdn.com/image/fetch/$s_!dLpy!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F26769578-d6b9-4dfa-b1b0-b00879101499_3456x1922.png)*Homepage > Library > Themes > + New theme.*

[
![](https://substackcdn.com/image/fetch/$s_!3oei!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc3e2eb4f-1ffc-4360-b755-480276502471_1826x998.png)

](https://substackcdn.com/image/fetch/$s_!3oei!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc3e2eb4f-1ffc-4360-b755-480276502471_1826x998.png)***Import file** works better in my opinion, with a few edits.*
...
Write it as instructions for a new team member who’s never seen our brand.Claude reads your assets and produces the .md file. 

Review it. Add anything Claude missed. Save it in your **[Cowork](https://ruben.substack.com/p/claude-cowork)** folder.

> *If you don’t understand how to manage Cowork folders, go **[here](https://ruben.substack.com/p/claude-cowork)**.*
...
- Default card count: [10-12]Now the file has your visual rules *and* your Gamma-specific settings. 
...
Read brand-deck-rules.md first. Create a Gamma presentation about [TOPIC] for [AUDIENCE]. Use our brand theme. [Anything specific about this deck].Claude reads the file, applies the rules, sends it to Gamma with your theme. On-brand from the first draft.
...
1. Drop the current **brand-deck-rules.md** + new brand assets into the folder.
2. Prompt: *“Read the current brand file and the new assets. Update the file with what changed. Keep everything else.”*
3. Review. Save.
