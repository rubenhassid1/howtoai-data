...
![](https://substack-post-media.s3.amazonaws.com/public/images/a6fbab32-48a1-4744-b557-ea30fc7488f2_1352x1572.png)

It’s really bad because:

1. You give vague descriptions.2. You don’t define what success looks like.3. You try to fit everything in one shot.
...
![](https://substack-post-media.s3.amazonaws.com/public/images/589c3efe-3a4b-4c33-bbf7-a52d5a44ac7c_1368x1000.png)
...
1. You need something quick. Like a Google search, or finding something in a PDF. The stakes are low, the task is quick. You do NOT need to use a complex prompt for this. Just the right settings, explained here.2. You need AI for a serious task. Heavy brainstorming, parsing a legal contract, creating a multi-step marketing plan, writing a brief to an agency… The sky is the limit, but the method is specific.
...
> AGI (=Artificial General Intelligence) will be a single markdown file.![](https://substack-post-media.s3.amazonaws.com/public/images/eab5defb-467b-41a3-ad98-1ca4fa23ceaa_1106x312.png)
...
- Find something that makes you say, “I want exactly this.” A contract. A memo. A proposal. A landing page. An email. A report.- Use a tool like MarkdownDown or copy it into a markdown converter.- Save the .md file. It’s a text file, but made for LLMs like ChatGPT.
...
> SUCCESS BRIEFType of output + length: [Contract, memo, report, proposal, landing page?]Recipient’s reaction: [What should they think/feel/do after reading?]Does NOT sound like: [What to avoid — generic AI, too casual, too legal, jargon-heavy?]Success means: [They sign? They approve? They reply? They take action]

Example for a C-level briefing:

> SUCCESS BRIEFType of output: Executive summary, 1 page max.Recipient’s reaction: “I understand the situation and know what to decide”.Does NOT sound like: Jargon-heavy consultant speak.Success means: They make a decision in the meeting without asking follow-up questions.

Example for a legal contract review:

> SUCCESS BRIEFType of output: Contract risk summary. 2 pages.Recipient’s reaction: “I know exactly what to negotiate”Does NOT sound like: Legalese that needs translatingSuccess means: Client can walk into negotiation prepared

Now you have three artifacts:

1. Your reference (markdown file).2. Your blueprint (the reverse-engineered breakdown).3. Your success brief (what YOUR version must achieve).
...
- A concrete example to follow- A breakdown of WHY it works- A brief defining YOUR success- Context about YOUR situation
...
![](https://substack-post-media.s3.amazonaws.com/public/images/89b2f4c6-6d22-4257-92a3-0f3fbf60facc_1856x2304.jpeg)

This is part of my prompt library, under the “**Cheat Sheet**” category.

![](https://substack-post-media.s3.amazonaws.com/public/images/684ec8a3-c03d-42b8-b11b-94f16b9f8219_1516x1578.png)
