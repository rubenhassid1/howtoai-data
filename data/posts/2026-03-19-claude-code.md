...
date: 2026-03-19
slug: claude-code
subtitle: "How to setup Claude Code (without coding):"
audience: free
url: https://ruben.substack.com/p/claude-code
---

You *finally* use **[Claude](https://ruben.substack.com/p/claude)** over ChatGPT.

Recently, you’ve been *abusing* **[Claude Cowork](https://ruben.substack.com/p/claude-cowork)**.

And you *successfully* created **[Claude Projects](https://ruben.substack.com/p/claude-for-teams)** for your team.
...
![You know Projects and Cowork. Don’t forget Claude Code.](https://substack-post-media.s3.amazonaws.com/public/images/f2a6bc88-8fd8-4e35-9015-f233c990a247_1080x1350.png)
*You know Projects and Cowork. Don’t forget Claude Code.*

And here’s the entire Claude product line, in short:

1. Chat → it’s like ChatGPT. A chatbot.2. Project → it’s still Claude Chat, but separated as individual Projects.3. Cowork → think Google Drive + Claude Project have a baby. Unbeatable.4. Code → massive revolution for developers to code much faster.
...
[Share](https://ruben.substack.com/p/claude-code?utm_source=substack&utm_medium=email&utm_content=share&action=share)
...
1. Go to claude.com/download. Download the app.2. You need a Pro account ($20/month). It’s very much worth it.3. Open the app. Click on the Code tab at the top next to Chat & Cowork.4. Select a folder from your computer. More about it down below.

You are not a developer. So why would you use Claude Code for?

- Create professional websites with prompts (= English).- Build personalized training from any piece of content.- Generate an interactive dashboard like a data analyst.
...
Go to **[github.com](https://github.com/)**. Click **Sign up** (right in the middle).

Add your email. Pick a username. Create a password. Done.

![The sign-up is free.](https://substack-post-media.s3.amazonaws.com/public/images/cd9963ab-bbf0-4a9f-98da-01e3cf183068_3456x1990.png)
*The sign-up is free.*

![Funny enough, I’ve never seen an “Are you a robot?” puzzle so hard… super annoying. And it’s 10 questions (!!!), sorry for that.](https://substack-post-media.s3.amazonaws.com/public/images/1039f96a-16f2-49d2-8161-cd3821cc2ee6_3456x1975.png)
...
1. Go to your Claude desktop app.2. Click on your Settings → Connectors.3. Go to Browse connectors → Search GitHub → Connect your GitHub.

![Go to your profile (bottom left) and click on Settings (step 2).](https://substack-post-media.s3.amazonaws.com/public/images/e8f18516-5f98-4351-a37a-b0adbb6eeec7_3456x2172.png)
*Go to your profile (bottom left) and click on Settings (step 2).*

![Go to Connectors → Browse connectors → Search GitHub → Connect it.](https://substack-post-media.s3.amazonaws.com/public/images/3836c3c3-15eb-4b31-a447-ffc20f4cc1ab_3456x2168.png)
*Go to Connectors → Browse connectors → Search GitHub → Connect it.*

#### Step 3: Code, but without code. Just type words.

1. Now go to Claude Code.2. Use Opus 4.6 + Auto accept edits.3. Make sure your GitHub is connected.4. Type a prompt that says what you want, for what, with an example.
...
![Prompt template + Opus 4.6 + Auto accept edits + Local + Adding screenshots](https://substack-post-media.s3.amazonaws.com/public/images/67febe56-6af9-4ba0-9dfe-95de0dd5c309_3456x2172.png)
*Prompt template + Opus 4.6 + Auto accept edits + Local + Adding screenshots*
...
![An example of recreating a company I know: iovis, an Airbnb for musicians.](https://substack-post-media.s3.amazonaws.com/public/images/ab08146b-e959-4f96-92f8-d5e3682f1d9f_3456x2172.png)
*An example of recreating a company I know: iovis, an Airbnb for musicians.*

![Click on “Always allow for session” every single time.](https://substack-post-media.s3.amazonaws.com/public/images/6fe4a098-2268-4e83-a228-34b73a62c588_3456x2172.png)
*Click on “Always allow for session” every single time.*

![This is the one-shot result (Claude Code on the left, preview on the right).](https://substack-post-media.s3.amazonaws.com/public/images/24a6244a-1d62-482f-9a92-f7c0a3e29295_3456x2172.png)
*This is the one-shot result (Claude Code on the left, preview on the right).*

Now, here’s your endless feedback loop:

1. Check the live website (ask “I need a link now so anyone can access it.”).2. Note down all of the problems you see when navigating.3. Follow up in Claude Code with a numbered list of the issues.4. Claude Code fixes it one by one.5. You go back to the live website. Refresh. Note down the issues…
...
![You get this sometimes 20+ times a session… and you must check your Claude Code always. So you can’t really work on something else at the same time.](https://substack-post-media.s3.amazonaws.com/public/images/d8ffb7a6-b0ad-4b18-abfd-67fb1c2ccdbb_3456x2172.png)
...
Go to **[code.visualstudio.com](https://code.visualstudio.com)**. Download it. Install it.

![It’s 100% free. It looks technical, but we will do very simple stuff, I promise.](https://substack-post-media.s3.amazonaws.com/public/images/489560bd-c058-4074-9aad-38e39b82a35e_3456x1926.png)
...
![Step 1: Bottom left “Settings” → Click on “Extensions”](https://substack-post-media.s3.amazonaws.com/public/images/be1c1f9a-125f-47ef-91c7-1702539f9b1a_3456x2170.png)
*Step 1: Bottom left “Settings” → Click on “Extensions”*

![Step 2: Search for “Claude” and download the one from Anthropic.](https://substack-post-media.s3.amazonaws.com/public/images/0977c278-5831-475e-a6f0-cd4af2eef3b0_3456x2168.png)
*Step 2: Search for “Claude” and download the one from Anthropic.*
...
![Step 1: Access the settings. It’s the only time we will.](https://substack-post-media.s3.amazonaws.com/public/images/39c4eaf9-1c2c-429c-a027-f2592b02937e_3456x2170.png)
*Step 1: Access the settings. It’s the only time we will.*

![Step 2: Turn on the Skip Permissions mode. That’s the magical one.](https://substack-post-media.s3.amazonaws.com/public/images/e83df810-9675-469c-99f6-001ae00005c1_3456x2164.png)
*Step 2: Turn on the Skip Permissions mode. That’s the magical one.*
...
![1. Click on the Claude logo 2. Open a new session 3. Bypass permissions 4. Use the right model and mode (just copy mine)](https://substack-post-media.s3.amazonaws.com/public/images/2cf814ea-0148-4bbd-af82-cf0bfc576d93_3456x2168.png)
*1. Click on the Claude logo 2. Open a new session 3. Bypass permissions 4. Use the right model and mode (just copy mine)*
...
Same context trick from **[Cowork](https://ruben.substack.com/p/claude-cowork)**. Works here too.
