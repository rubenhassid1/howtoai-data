...
1. Save this guide and spend 30 minutes this weekend to master Claude.2. Send it to anyone asking you, “I keep hearing about Claude, but I never tried it”.
...
1. Cowork (a desktop app that works on your actual files)2. Model (most of you use the wrong Claude)3. Excel (an AI inside your spreadsheets)4. Plugins (turn Claude into a specialist for your exact job)5. Artifacts (interactive outputs you can use, not just read)6. Projects (persistent context folders that remember everything)
...
1. Go to claude.com/download. Download the app.2. You need a Pro account ($20/month). Or $17/month if you pay annually.3. Open the app. Click the Cowork tab at the top.4. Select a folder from your computer. This is how Claude reads your files.5. Pro tip: create markdown files about you - or anything you want.6. Made a full guide on how to use Cowork here.
...
1. Open any Claude chat (on claude.ai or Cowork).2. Click the model selector dropdown at the bottom of the chat.3. Select Opus 4.6 + Extended Thinking.

![1. Click on the model 2. Select Opus 4.6 and 3. Turn on Extended thinking](https://substack-post-media.s3.amazonaws.com/public/images/af48be0f-0012-467b-800f-293390df26b4_3456x2168.png)
*1. Click on the model 2. Select Opus 4.6 and 3. Turn on Extended thinking*
...
1. Open Microsoft Excel (desktop or web). You need Excel 2016 or later.2. Go to Insert > Get Add-ins (Windows) or Tools > Add-ins (Mac).3. Search “Claude by Anthropic.” Look for the official one with the Claude logo.4. Click “Add” or “Get It Now.”5. Sign in with your Claude account.6. Press Ctrl+Option+C (Mac) or look for the Claude icon in your ribbon.
...
1. Go to Claude Cowork.2. Prompt it:
...
And what I got from this example:

![This is a one-shot, and it’s sensational. Can’t believe it’s this easy.](https://substack-post-media.s3.amazonaws.com/public/images/1026d0c5-7816-47a4-9378-9d1ff82185c0_3456x2172.png)
*This is a one-shot, and it’s sensational. Can’t believe it’s this easy.*
...
1. Open Claude Cowork.2. Go to claude.com/plugins.3. Browse the plugins. Pick one that matches your work.4. Click install. It activates automatically.5. Each plugin comes with its own slash commands.6. Type / in the chat to see what’s available.
...
A step-by-step guide to install Plugins *(as a video)*:
[Video]
[Subscribe now](https://ruben.substack.com/subscribe?)
...
![](https://substack-post-media.s3.amazonaws.com/public/images/e6531691-d825-42fb-9d47-dc25120edefc_3456x2172.png)
...
1. Go to claude.ai and log in (Pro or Team plan required).2. Click “Projects” in the left sidebar.3. Click “Create Project.” Give it a name (e.g., “My Newsletter”).4. Click “Add content.” Upload your key files: brand docs, writing samples, reference material, data. Don’t overbloat it.
...
![Gemini + Nano-Banana 2 + Thinking (bottom right) = best images](https://substack-post-media.s3.amazonaws.com/public/images/7b89f7c1-86ef-40fc-9ec7-8726ec76ed0f_3454x1934.png)
...
![Grok is connected to X, which covers 99.9% of what I need to search online.](https://substack-post-media.s3.amazonaws.com/public/images/b2394bd3-7bc3-43c8-a8dc-8f6c738c30be_3456x1926.png)
...
![Markdown files are the best kind of text files for LLMs (like Claude).](https://substack-post-media.s3.amazonaws.com/public/images/000ec11f-33d8-4d46-86a8-da263575161a_3456x1926.png)
